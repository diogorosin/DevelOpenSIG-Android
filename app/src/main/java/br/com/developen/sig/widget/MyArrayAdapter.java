...
/**
 * You can use this adapter to provide views for an {@link android.widget.AdapterView},
 ...
 * {@link android.widget.ListView} or {@link android.widget.Spinner}.
 * <p>
...
public class MyArrayAdapter<T> extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
    ...
    /**
     * Contains the list of objects that represent the data of this MyArrayAdapter.
    ...
    private @NonNull View createViewFromResource(@NonNull LayoutInflater inflater, int position,
        ...
        try {
            ...
            throw new IllegalStateException(
                    "MyArrayAdapter requires the resource ID to be a TextView", e);
        }
    ...
    /**
     * Creates a new MyArrayAdapter from external resources. The content of the array is
    ...
    private class ArrayFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                final String prefixString = Normalizer.normalize(
                        prefix.toString().toLowerCase(), Normalizer.Form.NFD).
                        replaceAll("[^\\p{ASCII}]", "");
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    final String valueText = Normalizer.normalize(
                            value.toString().toLowerCase(), Normalizer.Form.NFD).
                            replaceAll("[^\\p{ASCII}]", "");
